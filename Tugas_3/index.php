...
<head>
    ...
    <title>CSS - Javascript | Kelompok 2 Kelas F</title>
...
<body>
    ...
    <section class="text-center bg-primary-subtle padding">
        <div class="jumbotron padding">
            <h1 class="display-6">Selamat Datang di Tugas 4!</h1>
            <p class="lead">Ini adalah program membuat halaman index dengan HTML, CSS dan Java Script</p>
            <hr class="my-3">
            <p>CSS (Cascading Style Sheet) dan Java Script (JS)</p>
            <button type="button" class="btn btn-primary btn-lg" onclick="changeText()">Ubah Teks</button>
        </div>
    </section>
    <!-- Akhir Section -->
